...
"Predobject" creates the prediction object for evaluation using ROCR. Label.ordering specifies the direction, which determines how the negativity or positivity of an observation is determined.
...
plot(roc(train$y,fitted.g50.train,direction = ">"), col = "red", 
     legacy.axes= TRUE, lwd = 3, print.auc=TRUE, print.auc.x = 0.5, print.auc.y = 0.4,   # auc label coordinates
     xlab = "False Positive Rate", ylab= "True Positive Rate", add=TRUE)
...
plot(roc(test$y,fitted.g2.test,direction = ">"), col = "blue", 
     ...
     xlab = "False Positive Rate", ylab= "True Positive Rate")
plot(roc(test$y,fitted.g50.test,direction = ">"), col = "red", 
     legacy.axes= TRUE, lwd = 3, print.auc=TRUE, print.auc.x = 0.5, print.auc.y = 0.4,
     xlab = "False Positive Rate", ylab= "True Positive Rate", add=TRUE)
legend(.5, .2, legend=c("Gamma = 2", "Gamma = 50"),col=c("blue", "red"), lty=1:1, cex=0.65)
